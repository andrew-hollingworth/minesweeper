  ...
  return (
    <div className='box'>
      <button className=
        ...
        <i className={props.board.isRevealed ? `${props.board.isBomb ? `fas fa-skull-crossbones` : `fas fa-cookie-bite`}` : `${props.board.isFlag ? `far fa-grimace` : `fas fa-cookie-bite`}`}></i>
      </button>
    </div>
  )
}
